...
Vector3 Matrix::transform(Vector3& v) {
	double x  = elems[0] * v.x + elems[1] * v.y + elems[2] * v.z + elems[3];
	double y  = elems[4] * v.x + elems[5] * v.y + elems[6] * v.z + elems[7];
	double z  = elems[8] * v.x + elems[9] * v.y + elems[10] * v.z + elems[11];
